...
button_subtraction = Button(root, text="-", padx=40, pady=20, command=button_subs)
button_multiplication = Button(root, text="*", padx=40, pady=20, command=button_mult)
button_division = Button(root, text="/", padx=40, pady=20, command=button_divd)
button_e = Button(root, text="=", padx=92, pady=20, command=button_equal)
